            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post">
                        <p>Имя клиента</p>
                        <input type="text" name="userName" value="<?php echo $order['name']; ?>">

                        <p>Телефон клиента</p>
                        <input type="text" name="userPhone" value="<?php echo $order['phone']; ?>">

                        <p>Комментарий клиента</p>
                        <input type="text" name="userComment" value="<?php echo $order['comments']; ?>">
